   ...
   private WBClassImpl(Class<T> rawType, Type type, AnnotationStore annotationStore, ClassTransformer classTransformer)
   {
      ...
      for (Class<?> c = rawType; c != Object.class && c != null; c = c.getSuperclass())
      {
         for (Field field : c.getDeclaredFields())
         {
            ...
            {
               if (!field.getDeclaringClass().getPackage().getName().startsWith("java.util"))
               {
      ...
      for (Constructor<?> constructor : rawType.getDeclaredConstructors())
      {
         ...
         {
            if (!constructor.getDeclaringClass().getPackage().getName().startsWith("java.util"))
            {
      ...
      for (Class<?> c = rawType; c != Object.class && c != null; c = c.getSuperclass())
      {
         for (Method method : c.getDeclaredMethods())
         {
            ...
            {
               if (!method.getDeclaringClass().getPackage().getName().startsWith("java.util"))
               {
