...
public class JaxRsServletDelegate
{
   HttpServletDispatcher dispatcher = new HttpServletDispatcher();

   @Initializer
   public JaxRsServletDelegate(final ServletContext context) throws ServletException
   {
      dispatcher.init(new ServletConfig()
      {
         ...
         {
            return JaxRsServletDelegate.class.getName();
         }
