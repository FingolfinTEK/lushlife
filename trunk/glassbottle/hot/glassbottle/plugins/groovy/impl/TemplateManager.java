...
public class TemplateManager
{
   ...
   @Current
   private glassbottle.core.Injector injector;
   ...
   protected Template loadTemplate(String contextName, String resourceName)
   {
      ...
      return engine.create(ClassLoaderUtil.toClassPath(controller.getPackage().getName() + ".layout", resourceName));

   }

   public void include(String resourceName, Map<String, String> params, final Closure closure) throws IOException
   {
   ...
   public void include(String packageName, String resourceName, Map<String, String> params, final Closure closure) throws IOException
   {
      logger.info("include template [{0}],params [{1}]", resourceName, params);

      TemplateHandler tmp = injector.getInstanceByType(TemplateHandler.class).init(resourceName, params);
