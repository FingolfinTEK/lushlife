...
public class LFunction
{
   ...
   public void linkTo(String context, Map<String, Object> attr, final Closure closure)
   {
   ...
   private String buildLink(String context, Map<String, Object> attr)
   {
      ...
      if (view != null)
      {
         href = "/" + this.context.getServletPath() + "/" + context + "/" + BeansUtil.toClassName(String.valueOf(view));
      }
      else
      {
   ...
   public void javascript(String context, String resource, Map<String, String> attr)
   {
      ...
      attr.put("src", resourceManager.get().createUrl(context, "javascript", resource));
   ...
   private void form(Map<String, String> map, final Closure closure)
   {
      ...
      {
         map.put("action", "/" + context.getServletPath() + "/" + namespace.getName());
      }
   ...
   public void template(Map<String, String> params, Closure closure) throws IOException
   {
   ...
   public void template(String template, Map<String, String> map, Closure closure) throws IOException
   {
      manager.get().include(template, map, closure);
   }

   public void template(String packageName, String template, Closure closure) throws IOException
   {
      manager.get().include(packageName, template, new HashMap<String, String>(), closure);
   }

   public void template(String packageName, String template, Map<String, String> map, Closure closure) throws IOException
   {
