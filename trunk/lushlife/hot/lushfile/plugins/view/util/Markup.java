...
public class Markup {
	...
	public Markup tag(String tag, Map<String, String> map) {
		sb.append("<" + tag );
		writeAttribute(map);
		sb.append(" />");
		return this;
	...
	public Markup tag(String tag, Map<String, String> map, NestTag nestTag) {
		sb.append("<" + tag);
		writeAttribute(map);
		sb.append(">");
		indent++;
	...
	private void writeAttribute(Map<String, String> map) {
